...
Para alterar as informações por solução, selecione a solução que deseja visualização da lista no navegador esquerdo. O exemplo a seguir for filtrado para mostrar somente o Analytics:

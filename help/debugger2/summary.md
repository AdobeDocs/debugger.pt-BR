...
<table id="table_DC76D63FA6EF4891906B9E1D3E4A8A6C"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>O número da versão da <a href="https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/aep-extension/overview.html" format="html" scope="external">biblioteca do SDK da Web do AEB</a> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O nome da propriedade Launch especificada na extensão </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Domínio de Borda </p> </td> 
   <td colname="col2"> <p>O domínio do qual a extensão do Adobe Experience Platform envia e recebe dados de </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>ID da organização IMS </p> </td> 
   <td colname="col2"> <p>A organização para a qual você gostaria que os dados fossem enviados na Adobe, conforme especificado na extensão </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D30E0CD20FB04E41862B22655136E043"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>O tipo de <a href="https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/target-extension/overview.html" format="html" scope="external">evento</a> acionado quando a página é carregada </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Nome da solicitação </p> </td> 
   <td colname="col2"> <p>The name of a request around a <a href="https://docs.adobe.com/content/help/en/target/using/implement-target/client-side/mbox-implement/global-mbox/understanding-global-mbox.html" format="html" scope="external"> location</a> on the page. Disponível sem autenticação somente se você implementar o ouvinte de eventos de Depuração no código ou gerenciador de tags e ativar os <a href="https://docs.adobe.com/content/help/en/target/using/administer/response-tokens.html" format="html" scope="external">tokens de resposta</a> necessários na interface do usuário do Target. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A ID da experiência do Público alvo. Disponível sem autenticação somente se você implementar o ouvinte de eventos de Depuração no código ou gerenciador de tags e ativar os <a href="https://docs.adobe.com/content/help/en/target/using/administer/response-tokens.html" format="html" scope="external">tokens de resposta</a> necessários na interface do usuário do Target. </p> </td> 
  </tr> 
  <tr> 
